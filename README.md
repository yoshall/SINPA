...
- **Dataset Download**. We provide the dataset on: [https://huggingface.co/datasets/Huaiwu/SINPA](https://huggingface.co/datasets/Huaiwu/SINPA/tree/main). There are five files in the `./data` folder:
  ```
    ├── data
    │   ├── train.npz
    │   ├── val.npz
